      ...
      ?>
         ...
         ?>
            ...
            if (!empty($date_debut) && !empty($date_fin) && $date_debut > $date_fin) {
                ?>
                <script type="text/javascript">
                   document.getElementsByClassName('erreur_glo')[0].innerHTML = "!&nbsp;La date de début ne peut pas être supérieure à la date de fin";
                </script>
                <?php
            } else {
               
               if (!empty($date_debut) && !empty($date_fin) && (strtotime($date_debut) < time() || strtotime($date_fin) < time())) {
                  ?>
                  <script type="text/javascript">
                      document.getElementsByClassName('erreur_glo')[0].innerHTML = "!&nbsp;La date est déjà passée";
                  </script>
                  <?php
              } else {
